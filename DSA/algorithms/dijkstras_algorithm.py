...
class DijkstrasAlgorithm:
    ...
    def __init__(self, graph: DirectedGraphWeighted, starting_vertex: str) -> None:
        ...
        while not self._pq.empty():
            ...
            for neighbour, weight in graph.neighbours_to(current_vertex).items():
                if neighbour not in self._visited:
                    self._relax(current_vertex, neighbour, weight)
    ...
    def _relax(self, from_vertex: str, to_vertex: str, weight: float) -> None:
        ...
        :param from_vertex: The vertex that we're coming from.
        :param to_vertex: The vertex that we're going to.
        :param weight: The weight between the from and to vertex.
        """
